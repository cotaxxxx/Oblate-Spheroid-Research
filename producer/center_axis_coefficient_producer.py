...
def run():
    ...
    print('LOGICAL_FINAL_CLAIMS', 'PASS' if mono_ok and left_ok and right_ok else 'UNRESOLVED', 'A1/A2 from global monotonicity; A3 by restriction')
    if not (mono_ok and left_ok and right_ok): raise SystemExit('UNRESOLVED')
