...
def verify():
    ...
    print('LOGICAL_FINAL_CLAIMS','PASS' if mono and lok and rok else 'UNRESOLVED','A1/A2 from global monotonicity; A3 by restriction')
    if not (mono and lok and rok): raise SystemExit('UNRESOLVED')
