#!/usr/bin/env python3
"""Transcribed checker for C1c lower-half post-crossing exclusion.

CHECKER_KERNEL=TRANSCRIBED_COPY_NOT_INDEPENDENT_DERIVATION
INDEPENDENCE_SCOPE=PRECISION/PARTITION/GATING/RECEIPT
"""
...
def verify():
    ctx.prec = BITS
    base.ctx.prec = BITS
    print("GLOBAL_AXIAL_C1C_CHECKER — PROTOTYPE / NOT_BINDING")
    ...
    print("INDEPENDENCE_SCOPE PRECISION/PARTITION/GATING/RECEIPT")
